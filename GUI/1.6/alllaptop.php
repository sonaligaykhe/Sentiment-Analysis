  ...
  <div class="ix-list-viewport" style="height: 500px">
    ...
    <ul class="ix-list-items" style="">
      ...
      <li class="ix-list-item" id="1">
        <a href="resultpage.php"><img src="Dell.jpg" height="200px" ></a>
      </li>
      <li class="ix-list-item" id="2">
        <a href="resultpage.php"><img src="Lenovo.jpg" height="200px"></a>
      </li>
      <li class="ix-list-item" id="3">
        <a href="resultpage.php"><img src="HP.jpg" height="200px"></a>
      </li>
      <li class="ix-list-item" id="4">
        <a href="resultpage.php"><img src="Apple.jpg" height="200px"></a>
      </li>
    </ul>
  </div>
