  ...
  <div class="ix-list-viewport" style="height: 500px">
    ...
    <ul class="ix-list-items" style="">
      ...
      <li class="ix-list-item" id="1">
        <a href="resultpage.php"><img src="HP_p.jpeg" height="100px" style ="margin:100px" ></a>
      </li>
      <li class="ix-list-item" id="2">
        <a href="resultpage.php"><img src="Sandisk.jpg" height="200px"></a>
      </li>
      <li class="ix-list-item" id="3">
        <a href="resultpage.php"><img src="Sony_p.jpeg" height="150px" style ="margin:100px"></a>
      </li>
      <li class="ix-list-item" id="4">
        <a href="resultpage.php"><img src="PNY.jpg.jpeg" height="150px" style ="margin:100px"></a>
      </li>
    </ul>
  </div>
